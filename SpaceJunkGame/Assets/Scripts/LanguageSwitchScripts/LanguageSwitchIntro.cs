...
public class LanguageSwitchIntro : MonoBehaviour
{
    ...
    private void Awake()
    {
        if (LangSwitchBool.englishTxt)
        {
            ...
            question.text = "Are you familiar with the problems the space debris in earth's orbit causes?";
            yes.text = "Yes";
            no.text = "No";
            ...
            textSkip.text = "Press screen to skip text";
            textSkip.fontSize = 50;
        }
        else
        {

            question.text = "Ben je bekend met de problemen dat ruimteafval veroorzaakt?";
            yes.text = "Ja";
            no.text = "Nee";
            ...
            textSkip.text = "Houdt het scherm ingedrukt om tekst over te slaan";
