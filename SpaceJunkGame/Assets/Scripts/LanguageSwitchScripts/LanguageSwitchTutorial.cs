...
public class LanguageSwitchTutorial : MonoBehaviour
{
    ...
    void Awake()
    {
        if (LangSwitchBool.englishTxt)
        {
            ...
            part14point1.text = "If you ever need help, press the ? button to read up on what I teached you here.";
        ...
        else
        {
            ...
            part14point1.text = "Als je ooit hulp nodig hebt, druk op de ? om hulp te zien te krijgen.";
